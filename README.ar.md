...
# XXD Panel 111｜سجلّ الكولاج النسيجي

خيّط العلاقة الأهم في الصورة لتصبح ختماً بصرياً دافئاً.
...
قد تكمن جاذبية الصورة في علاقة أو ملمس الثياب أو لحظة صمت لا في كثرة المعلومات. يحافظ **Panel 111** على واقع الصورة ويخيط النصف الآخر كختم بصري صغير من قماش منسل وألياف وغرز ظاهرة. يناسب الذكريات والعلاقات والحيوانات والطبيعة والنشر والمعارض.

يعالج المرشحات التي تفتقر إلى اللمس، والكولاج المحشو بالمواد، والحرفة التي تبدو رخيصة، وضياع العلاقة الأساسية تحت الزخرفة.
...
**البصمة:** ذاكرة انتقائية · كولاج نسيجي مخيط يدوياً · غرز ظاهرة · 2–4 ألوان قماش من المصدر · موضوع صغير كختم · فراغ تحريري واسع

## فحص الملاءمة السريع

| ما تحتاجه | ما يقدمه Panel 111 |
|---|---|
| دفء الصورة بلا مرشح عادي | يبقي الواقع ويخيط النصف الآخر من القماش والحواف المنسلة والغرز. |
| كولاج مواد غير مزدحم | يختزل علاقة مركزية في ختم صغير ويترك حولها مساحة للتنفس. |
| حرفة يدوية بلا مظهر رخيص | يستخدم 2–4 ألوان من الأصل وأليافاً ملموسة وغرزاً مقيدة لنتيجة تحريرية. |

## منطق التحويل

```text
فهم الموضوع والعلاقة → حذف التفاصيل غير المهمة → استخلاص البنية ونقاط الذاكرة → إعادة البناء بالقماش والحواف والغرز → إكمال ختم صغير وفراغ واسع
```

## سمات النتيجة

- الواقع والترجمة النسيجية داخل لوحة كاملة واحدة؛ المقارنة 50:50 تماماً بلا شريط ثالث.
- يحتفظ الجانب المصمم بالبنية والحركة والعلاقة التي تعرّف الأصل، بلا نسخ كل الأشياء أو ملء الخلفية.
- تظهر ألياف القطن والكتان والخيوط والحواف غير المنتظمة والغرز كمادة حقيقية لا كملصقات رقمية.
- تُستخلص 2–4 ألوان حيوية من الصورة الحالية وتوازنها أرضية قماش فاتحة.
- النص قليل، ويمكن إزاحة الموضوع أو قصه أو تعليقه ليشارك الفراغ في التكوين.
...
تُحدد لغة النص صراحة. يتبع `prompt` الأصل، ويحفظ `exact` كلام المستخدم حرفياً، ويمنع `none` الحروف والأرقام والشعارات والنص الزائف. لا تُخمن اللغة من الشخص أو المكان أو اسم الملف.

## أوضاع الإخراج الأربعة

- `top-bottom`: الصورة الواقعية في الأعلى وتصميم Panel 111 في الأسفل، بنسبة 50% لكل منهما.
...
بعد التثبيت أعد تشغيل جلسة الوكيل ثم استدعِ `$xxd-panel-111`.

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel

تم تحديث سلسلة XXD Panel الحالية لتشمل 001–112، ويحتفظ كل Panel بموجّهه الأصلي ومنطقه الجمالي المستقل. الجدول أدناه هو الدليل التاريخي حتى وقت إصدار هذا المشروع؛ يسرد 001–111 بصورة متتابعة، ويظهر المشروع الحالي بخط عريض.
